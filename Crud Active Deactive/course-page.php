        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    <?php 
                    if($course['status']=="2") 
                        echo "<a href=deactivate.php?id=".$course['id']." class='btn green'>Complete</a>";
                    elseif($course['status']=="1")  
                        echo "<a href=activate.php?id=".$course['id']." class='btn red'>Failed</a>";
                    else
                    echo "<a href=semi.php?id=".$course['id']." class='btn blue'>Processing</a>";
